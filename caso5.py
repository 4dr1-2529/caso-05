#integrantes
#veliz de la cruz carlos adrian // de la torre segura andre // cajamalqui davila josemaria píero // albornoz quiliano jose antonio
class Producto:
    ...
    def eliminar_producto(self, producto_nombre, cantidad_a_eliminar):
        ...
        for producto in self.productos:
            if producto.nombre == producto_nombre:
                ...
                return
        print(f"Producto {producto_nombre} no encontrado en el inventario.")  # Producto no encontrado
